          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Minimum 50 characters. Be clear and detailed to attract
                  quality applicants.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Set your budget to help applicants understand your
                  expectations. This is optional but recommended. The min and
                  max should be the same if you want a single amount.
                </p>
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 border rounded-lg bg-blue-50 dark:bg-blue-950/20">
              ...
              <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                ...
                <li>
                  • You can cancel the gig anytime before selecting an
                  application
                </li>
              </ul>
            </div>
