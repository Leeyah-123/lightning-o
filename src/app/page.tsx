...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <Hero
        activeBounties={
          bounties.filter((bounty) => bounty.status === 'open').length || 0
        }
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">How Lightning Works</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              A complete platform for decentralized work powered by Nostr and
              Lightning
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent>
                ...
                <p className="text-muted-foreground mb-4">
                  Create and complete specific tasks for Lightning payments
                </p>
                <Link href="/bounties">
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent>
                ...
                <p className="text-muted-foreground mb-4">
                  Find short-term work opportunities for quick payments
                </p>
                <Link href="/gigs">
                  <Button variant="outline" className="w-full">
                    Explore Gigs
        ...
        {/* Recent Bounties */}
        {isInitialized && recentBounties.length > 0 && (
          <section className="mb-16">
        ...
        <section className="text-center bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20 rounded-2xl p-12">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join the future of decentralized work. Create bounties, find gigs,
            and get paid instantly with Lightning.
          </p>
